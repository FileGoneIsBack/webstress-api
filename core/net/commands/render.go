...
func renderLine(session *sessions.Session, line string, adminrole bool, apirole bool, cncrole bool, viprole bool, details *CommandDetails, currentTime string, ipinfo utils.GeoIPDetails, attacks int) {
...
func processLines(session *sessions.Session, lines []string, details *CommandDetails) {
    ...
    for _, line := range lines {
        renderLine(session, line, adminrole, apirole, cncrole, viprole, details, currentTime, ipinfo, len(attacks))
    }
}
